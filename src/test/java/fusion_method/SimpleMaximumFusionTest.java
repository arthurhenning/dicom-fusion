 ...
 */
public class SimpleMaximumFusionTest extends TestCase {

    public SimpleMaximumFusionTest(String testName) {
        super(testName);
    }
    ...
    /**
     * Test of fuse method, of class SimpleMaximumFusion.
     */
    public void testFuse() {
        ...
        image2.show();
        SimpleMaximumFusion instance = new SimpleMaximumFusion();
